      ...
      <div className="fixed top-4 left-1/2 -translate-x-1/2 z-50 animate-slide-up">
        <nav className="flex items-center gap-1 bg-white/95 backdrop-blur-md border border-zinc-200 rounded-full shadow-lg shadow-black/5 px-2 py-2">
          ...
          <div className="flex items-center text-sm">
            ...
            <Link href="/networking-board" className="hidden sm:block px-3 py-1.5 text-zinc-500 hover:text-zinc-900 hover:bg-zinc-100 rounded-full transition-colors">Board</Link>
          </div>
          <div className="w-px h-4 bg-zinc-200 mx-1" />
